...
public class MenuView extends LinearLayout {
    ...
    public MenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ACTION_DIMENSION_PX = AndroidUtil.dpToPx(48);
        init();
    }
    ...
    private void init() {
        ...
        mActionIconColor = AndroidUtil.getColor(getContext(), R.color.gray_active_icon);
        mOverflowIconColor = AndroidUtil.getColor(getContext(), R.color.gray_active_icon);
    }
    ...
    private void refreshColors() {
        for (int i = 0; i < getChildCount(); i++) {
            AndroidUtil.setIconColor(((ImageView) getChildAt(i)), mActionIconColor);
            if (mHasOverflow && i == getChildCount() - 1) {
                AndroidUtil.setIconColor(((ImageView) getChildAt(i)), mOverflowIconColor);
            }
        }
    }
    ...
    public void reset(int menu, int availWidth) {
        ...
        if (availItemRoom > 0) {
            for (int i = 0; i < localActionItems.size(); i++) {
                ...
                if (menuItem.getIcon() != null) {
                    ...
                    AndroidUtil.setIconColor(action, mActionIconColor);
                    addView(action);
        ...
        if (addOverflowAtTheEnd) {
            ...
            overflowAction.setImageResource(R.drawable.ic_more_vert);
            AndroidUtil.setIconColor(overflowAction, mOverflowIconColor);
        ...
        if (mOnVisibleWidthChangedListener != null) {
            mVisibleWidth = ((int) ACTION_DIMENSION_PX * getChildCount()) - (mHasOverflow ? AndroidUtil.dpToPx(8) : 0);
    ...
    public void hideIfRoomItems(boolean withAnim) {
        ...
        for (actionItemIndex = 0;
            ...
            if (mActionItems.get(actionItemIndex).getItemId() != showAlwaysActionItem.getItemId()) {
                ...
                AndroidUtil.setIconColor(action, mOverflowIconColor);
                action.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
        ...
        for (int i = 0; i < actionItemIndex; i++) {
            ...
            final float destTransX = (ACTION_DIMENSION_PX * diff) - (mHasOverflow ? AndroidUtil.dpToPx(8) : 0);
    ...
    public void showIfRoomItems(boolean withAnim) {
        ...
        animSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mOnVisibleWidthChangedListener != null) {
                    mVisibleWidth = (getChildCount() * (int) ACTION_DIMENSION_PX) - (mHasOverflow ? AndroidUtil.dpToPx(8) : 0);
                    mOnVisibleWidthChangedListener.onItemsMenuVisibleWidthChanged(mVisibleWidth);
                }
            }
        });
