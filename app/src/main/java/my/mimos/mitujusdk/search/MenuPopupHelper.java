...
public class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    public boolean tryShow() {
        ...
        int vertOffset = -mAnchorView.getHeight() + AndroidUtil.dpToPx(4);
        int horizontalOffset = -mContentWidth + mAnchorView.getWidth();
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            vertOffset = -mAnchorView.getHeight() - AndroidUtil.dpToPx(4);
            horizontalOffset = -mContentWidth+mAnchorView.getWidth() - AndroidUtil.dpToPx(8);
        }
