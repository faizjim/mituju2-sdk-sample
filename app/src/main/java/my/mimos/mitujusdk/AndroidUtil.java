...
/**
 * Created by ariffin.ahmad on 03/10/2017.
 */
...
public class AndroidUtil {
    ...
    public static Drawable getWrappedDrawable(Context context, @DrawableRes int resId) throws Resources.NotFoundException {
        return DrawableCompat.wrap(context.getResources().getDrawable(resId)); //,  ResourcesCompat.getDrawable(context.getResources(), resId, null));
    }
